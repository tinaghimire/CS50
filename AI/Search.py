...
class StackFrontier():
    ...
    def add(self, node):
        self.frontier.append(node)  #Add states to the frontier
...
class QueueFrontier(StackFrontier):
    # QueueFrontier inherits from StackFrontier
...
class Maze():
    ...
    def solve(self):
        ...
        frontier = StackFrontier()  # Algorithm used Depth First Search
        # frontier = QueueFrontier()  # Algorithm used Breadth First Search
        frontier.add(start)
